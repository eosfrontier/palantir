...
class event {
	...
	public function get_all() {
		$stmt = database::$conn->prepare( "SELECT e.id, e.title, e.title_en, orga.name as organisatie, orga.name_en as organization, orga.id as orga_id, e.event_date, e.event_end_date, loc.name as location_name, 
