...
$app['header']   = '/api/palantir'; // location of the application. for example: http://localhost/api/palantir/ == '/api/palantir'. If the application is in the ROOT, you can leave this blank.
